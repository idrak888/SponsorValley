...
var scrollFunction = function scrollFunction() {
  if (document.body.scrollTop > 20 || document.documentElement.scrollTop > 20) {
    document.querySelector('.SponsorModule').classList.add('.show');
  } else {
    document.querySelector('.SponsorModule').classList.remove('.show');
  }
};
...
//# sourceMappingURL=index.js.f46ea2923c838fd7b104.hot-update.js.map