...
function (_Component) {
  ...
  function SponsorDash() {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_6__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4__["default"])(_this), "uploadLogo", function (e) {
      ...
      var firestoreRef = firebase__WEBPACK_IMPORTED_MODULE_9__["storage"]().ref();
      uploadBtn.disabled = true;
      loader.style.display = 'inline-block'; // File or Blob named mountains.jpg

      var file = document.querySelector('#file'); // Create the file metadata

      var metadata = {
        contentType: 'image/jpeg'
      }; // Upload file and metadata to the object 'images/mountains.jpg'

      var uploadTask = storageRef.child(_this.props.companyName + '/image').put(file, metadata); // Listen for state changes, errors, and completion of the upload.
...
//# sourceMappingURL=dashboard.js.c00b69235d2d2a0aaefc.hot-update.js.map